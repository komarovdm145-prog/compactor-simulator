...
{t:'Плиты сжимают бунт',x:'Левая и правая плиты сходятся навстречу друг другу. Бунт становится короче и плотнее.',v:'press'},
...
function graphic(v){
 ...
 if(v==='press')return base('compressed')+'<div class="note">Плиты сжали бунт</div>';
